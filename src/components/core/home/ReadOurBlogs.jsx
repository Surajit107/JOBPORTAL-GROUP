          ...
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <div className="section-heading">
                ...
                <p>
                  Reflections of an Executive Resume Writer, a source for
                  authoritative and creative executive resume-writing and
                  career-transition strategies, as well as timely articles and
                  commentary on the latest issues and trends.
                </p>
              </div>
            </div>
          </div>
                ...
                ?.map((curElm) => {
                  return (
                    <section className="tabs-content" key={curElm.id}>
                      <article id="tabs-1">
                        <img
                          src="assets/images/blog-image-1-940x460.jpg"
                          alt=""
                        />
                        <h4>{curElm.title}</h4>
